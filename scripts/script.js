/****************** YOUR NAME: Rodrigo Alves Rangel
...
const swichModelText = document.getElementById("model-text");
switchModel.addEventListener("click", changeModel);
function changeModel() {
	if (modelName == 'XYZ') {
		modelName = 'CPRG';
		swichModelText.innerHTML = "Model CPRG";
	}
	else if (modelName == 'CPRG') {
		modelName = 'XYZ';
		swichModelText.innerHTML = "Model XYZ";
	}
